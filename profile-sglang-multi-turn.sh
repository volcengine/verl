...
COMMAND="nohup env EXPERIMENT_NAME=${EXPERIMENT_NAME} bash examples/sglang_multiturn/run_qwen2.5-3b_gsm8k_multiturn.sh trainer.experiment_name=multiturn-tp-${TP_SIZE}-${TIMESTAMP} >> logs/gsm8k-multiturn-tp-${TP_SIZE}-${TIMESTAMP}.log 2>&1 &"
