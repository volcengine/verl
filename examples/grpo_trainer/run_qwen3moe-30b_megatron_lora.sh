...
# NOTE: Currently, MoE LoRA only supports target_modules=["linear_qkv", "linear_proj"] in Megatron-Bridge.
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.lora.target_modules='["linear_qkv","linear_proj"]' \
