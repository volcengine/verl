...
MODEL_PATH="/mnt/nas/alex/verl/converted-model/r-horizon-qwen3-vl-8b-vision-mix-rhorizon-k2/checkpoint-55" # Path to your base model
...
OUTPUT_DIR="./checkpoints/r-horizon-rl-qwen3-vl-8b-vision-mix-rhorizon-k-234" # Directory to save checkpoints and logs
...
micro_batch_logprob_size_per_gpu=2
MAX_PROMPT_LENGTH=2048
RESPONSE_LENGTH=16384 # Renamed from RES_LENGTH for clarity
GROUP_SIZE=16
N_VAL_SAMPLES=8
TRAIN_TEMPERATURE=1.
WANDB_MODE='online'
