...
MODEL_PATH="/mnt/nas/alex/models/Qwen/Qwen3-VL-8B-Thinking" # Path to your base model
...
OUTPUT_DIR="./checkpoints/r-horizon-rl-qwen3-vl-8b-vision-mix-rhorizon-k2" # Directory to save checkpoints and logs
...
train_files="[\"/mnt/nas/bachvd/Code-Agent/verl/data/r-horizon-vision-text-only-single-train/train_k2.parquet\",\"/mnt/nas/bachvd/Code-Agent/verl/data/r-horizon-vision-v2/train.parquet\"]"
...
PROJECT_NAME="Qwen3-VL-8B-R-HORIZON-RL-Training-k-2"
EXP_NAME="grpo-vision-mix-text-$(basename ${MODEL_PATH})-$(date +%Y%m%d-%H%M%S)"
...
python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=10524 \
