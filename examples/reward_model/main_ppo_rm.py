...
from verl.trainer.ppo.shared_ray_trainer import SharedPoolRayPPOTrainer, RoleLayoutConfig, RoleLayoutConfigItem
from verl.trainer.ppo.reward import load_reward_manager
from verl.utils.device import is_cuda_available
from verl.utils.import_utils import load_extern_type


@hydra.main(config_path="config", config_name="ppo_trainer_rm", version_base=None)
def main(config):
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        from verl.trainer.ppo.shared_ray_trainer import ColocateResourcePoolManager

        global_pool_id = "global_pool"
        global_group_id = "global_group"
        rm_group_id = "rm_group"
        ...
        trainer = SharedPoolRayPPOTrainer(
            config=config,
            tokenizer=tokenizer,
            processor=processor,
