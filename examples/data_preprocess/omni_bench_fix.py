...
if __name__ == "__main__":
    ...
    import glob
    dataset = datasets.load_dataset(data_source, split="train",) # this dataset has no test split
    ...
    to_remove_columns = list(set(train_dataset.column_names)-set(["audios", "images", "ability", "extra_info", "data_source", "prompt", "ability", "reward_model", "question", "answer", "image", "audio"]))
