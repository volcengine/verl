...
# 2-GPU Tensor Parallel for rollout (TP=2), DP=1 for training, 2 epochs (~116 steps)
...
LOG_PATH="$OUT_DIR_ABS/tp_2gpu_ep2.log"

echo "[run] TP=2 (rollout), DP=1 (train), 2 epochs"
