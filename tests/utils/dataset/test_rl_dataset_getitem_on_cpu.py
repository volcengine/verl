...
class TestRLHFDatasetGetItem:
    ...
    def test_basic_text_only_item(self, tokenizer, basic_config):
        ...
        with patch('verl.utils.torch_functional.postprocess_data') as mock_postprocess, \
    ...
    def test_truncation_strategies(self, tokenizer, basic_config):
        ...
        data_dict = {
            "prompt": [[{"role": "user", "content": "This is a very long message that will definitely exceed the token limit"}]],
            "extra_info": [{"index": 0}]
        }
