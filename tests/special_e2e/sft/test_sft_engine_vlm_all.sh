...
# BACKEND=fsdp SP_SIZE=1 FSDP_SIZE=1 NUM_GPUS=2 FSDP_STRATEGY=fsdp bash ${FILE_PATH}

# BACKEND=fsdp SP_SIZE=1 FSDP_SIZE=1 NUM_GPUS=8 FSDP_STRATEGY=fsdp bash ${FILE_PATH}

BACKEND=fsdp SP_SIZE=1 FSDP_SIZE=1 NUM_GPUS=1 FSDP_STRATEGY=fsdp2 bash ${FILE_PATH}

BACKEND=fsdp SP_SIZE=1 FSDP_SIZE=1 NUM_GPUS=2 FSDP_STRATEGY=fsdp2 bash ${FILE_PATH}
