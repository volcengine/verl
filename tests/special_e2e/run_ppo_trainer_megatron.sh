...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +actor_rollout_ref.actor.optim.override_optimizer_config.overlap_cpu_optmizer_d2h_h2d=$OPTIM_MEMORY_EFFICIENT \
    ...
    +critic.optim.override_optimizer_config.overlap_cpu_optmizer_d2h_h2d=$OPTIM_MEMORY_EFFICIENT \
