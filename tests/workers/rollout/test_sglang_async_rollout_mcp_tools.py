...
class TestRolloutWithMCPSearchTools:
    ...
    @patch.object(MCPClientManager, "fetch_tool_schemas", return_value=None)
    def test_over_size_case(self, mock_fetch, mock_rollout, search_data_proto, search_data):
        tool_schema = [
            {
                "type": "function",
                "function": {
    ...
    def test_tool_call_basic_case(self, mock_execute, mock_fetch, mock_rollout, search_data_proto, search_data):
    ...
    @patch.object(MCPClientManager, "fetch_tool_schemas", return_value=None)
    @patch.object(MCPSearchTool, "execute", new_callable=AsyncMock)
    def test_tool_call_batch_case(self, mock_execute, mock_fetch, mock_rollout, search_data_proto, search_data):
        _, expect_turn_array, tool_return_array = search_data
        tool_schema = [
            {
                "type": "function",
