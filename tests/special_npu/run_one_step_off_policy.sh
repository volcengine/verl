...
NUM_GPUS=${NUM_GPUS:-8}
ACTOR_STRATEGY=${ACTOR_STRATEGY:-"megatron"}  # fsdp2 or megatron
...
exp_name="$(basename "${MODEL_ID,,}")-one-step-off-policy-megatron-minimal"

echo "Running one_step_off_policy with megatron strategy"
...
common_params=(
    ...
    trainer.weight_sync_with_ray=False 
    trainer.nnodes=1
