...
**表1** RL类算法
    ...
    +-----------------------+-------------------------+------------------------------------------------------------------+-------------------+-------------------+----------------------------------------------------------------------------------------------------------------------------------------------+--------------------------+
    |   DAPO                | Qwen2.5-VL-3B-instruct  |`3B <https://huggingface.co/Qwen/Qwen2.5-VL-3B-Instruct>`_        |        FSDP2      |    vllm-ascend    |`qwen2_5_vl_3b_npu <https://github.com/verl-project/verl-recipe/blob/main//dapo/run%20dapo_qwen2.5_vl_3b_fsdp2_npu.sh>`_                        |    Atlas 800T A3         |
    +-----------------------+-------------------------+------------------------------------------------------------------+-------------------+-------------------+----------------------------------------------------------------------------------------------------------------------------------------------+--------------------------+
    |   DAPO                | Qwen2.5-VL-7B-instruct  |`7B <https://huggingface.co/Qwen/Qwen2.5-VL-7B-Instruct>`_        |        FSDP2      |    vllm-ascend    |`qwen2_5_vl_7b_npu <https://github.com/verl-project/verl-recipe/blob/main//dapo/run%20dapo_qwen2.5_vl_7b_fsdp2_npu.sh>`_                        |    Atlas 800T A3         |
    +-----------------------+-------------------------+------------------------------------------------------------------+-------------------+-------------------+----------------------------------------------------------------------------------------------------------------------------------------------+--------------------------+
    |   DAPO                | Qwen2.5-VL-32B-instruct |`32B <https://huggingface.co/Qwen/Qwen2.5-VL-32B-Instruct>`_      |        FSDP2      |    vllm-ascend    |`qwen2_5_vl_32b_npu <https://github.com/verl-project/verl-recipe/blob//main/dapo/run%20dapo_qwen2.5_vl_32b_fsdp2_npu.sh>`_                      |    Atlas 800T A3         |
    +-----------------------+-------------------------+------------------------------------------------------------------+-------------------+-------------------+----------------------------------------------------------------------------------------------------------------------------------------------+--------------------------+
    |   DAPO                | Qwen3-VL-30B-instruct   |`30B <https://huggingface.co/Qwen/Qwen3-VL-30B-A3B-Instruct>`_    |        FSDP2      |    vllm-ascend    |`qwen3_vl_30b_npu <https://github.com/verl-project/verl-recipe/blob/main//dapo/run%20dapo_qwen3_vl_30b_fsdp2_npu.sh>`_                          |    Atlas 800T A3         |
    +-----------------------+-------------------------+------------------------------------------------------------------+-------------------+-------------------+----------------------------------------------------------------------------------------------------------------------------------------------+--------------------------+
