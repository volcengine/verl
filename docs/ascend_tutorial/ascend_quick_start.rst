...
**表3** comming soon
    ...
    |         model           |                            download link                                 |
    +-------------------------+--------------------------------------------------------------------------+
    | Qwen3-next-80B          |         `80B <https://huggingface.co/Qwen/Qwen3-Next-80B-A3B-Instruct>`_ |
    +-------------------------+--------------------------------------------------------------------------+
    | Qwen3-MoE-235B          |         `235B <https://huggingface.co/Qwen/Qwen3-235B-A22B>`_            |
    +-------------------------+--------------------------------------------------------------------------+
    | gpt-oss 20B             |         `20B <https://huggingface.co/openai/gpt-oss-20b>`_               |
    +-------------------------+--------------------------------------------------------------------------+
    | DeepSeekv3.2            |         `v3.2 <https://huggingface.co/deepseek-ai/DeepSeek-V3.2>`_       |
    +-------------------------+--------------------------------------------------------------------------+
