...
# Get input/output paths, defaulting to geo3k paths if not provided
train_input = input("Enter path to train input file (default: ~/data/geo3k/train.parquet): ").strip() or '~/data/geo3k/train.parquet'
train_output = input("Enter path to train output file (default: ~/data/geo3k/train_clean.parquet): ").strip() or '~/data/geo3k/train_clean.parquet'
test_input = input("Enter path to test input file (default: ~/data/geo3k/test.parquet): ").strip() or '~/data/geo3k/test.parquet'
test_output = input("Enter path to test output file (default: ~/data/geo3k/test_clean.parquet): ").strip() or '~/data/geo3k/test_clean.parquet'

train_df = inspect_and_fix_all_data(train_input, train_output)
test_df = inspect_and_fix_all_data(test_input, test_output)
