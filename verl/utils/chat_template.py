...
def initialize_system_prompt(tokenizer, add_generation_prompt=False, **apply_chat_template_kwargs) -> list[int]:
    """
    ...
    try:
        return tokenizer.apply_chat_template(
            [{}], add_generation_prompt=add_generation_prompt, tokenize=True, **apply_chat_template_kwargs
        )
