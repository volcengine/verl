...
from verl.utils.fsdp_utils import fsdp_version, get_fsdp_state_ctx, get_full_state_dict
...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None):
        ...
        if self.should_save_hf_model:
            ...
            state_dict = get_full_state_dict(self.model, full_state_dict=True, offload_to_cpu=True, rank0_only=True)
