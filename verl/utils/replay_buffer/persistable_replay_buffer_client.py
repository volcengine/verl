...
class PersistableReplayBufferClient(ReplayBufferClient):
    # TODO: it's system-dependent, should read it from a config or env var
    DB_BASE_DIR = "/opt/tiger/"
    MAGIC_SUFFIX = "replay_buffer_db_1735829"

    def __init__(self, replay_buffer_name, cache_size_limit_in_mb, restore_from_hdfs_path=None, samplers=[]):
        """
        ...
        self._db_path = os.path.join(
            PersistableReplayBufferClient.DB_BASE_DIR, PersistableReplayBufferClient.MAGIC_SUFFIX, replay_buffer_name
        )
