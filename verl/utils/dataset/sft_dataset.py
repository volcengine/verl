...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        def series_to_item(ls):
            ...
            while isinstance(ls, (pandas.Series, numpy.ndarray)) and len(ls) == 1:
                if isinstance(ls, numpy.ndarray):
                    ls = ls[0]
                elif isinstance(ls, pandas.Series):
                    ls = ls.iloc[0]
            return ls
        ...
        # Ensure self.responses is a pandas Series before converting to list. It may happen when user does not specify response_dict_keys.
