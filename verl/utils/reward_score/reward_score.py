...
def reward_func(data_source, solution_str, ground_truth, extra_info=None):
    if data_source in ['Maxwell-Jia/AIME_2024', "opencompass/cnmo2024_en", "opencompass/cnmo2024_zh", "lighteval/MATH", "openai/gsm8k", "DigitalLearningGmbH/MATH-lighteval"]:
        ...
        from verl.utils.reward_score import livecodebench
