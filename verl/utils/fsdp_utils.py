...
def apply_fsdp2(model, fsdp_kwargs, config):
    ...
    fsdp_transformer_layer_cls_to_wrap = config.get("wrap_policy", {}).get("transformer_layer_cls_to_wrap")
    if not fsdp_transformer_layer_cls_to_wrap:  # None or empty list/tuple/dict/str
