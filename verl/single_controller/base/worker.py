...
from verl.utils.device import get_visible_devices_prefix, get_torch_device
...
class Worker(WorkerHelper):
    ...
    def env_keys(cls):
        ...
        return [
            ...
            "MASTER_ADDR",
            "MASTER_PORT",
            f"{get_visible_devices_prefix()}_VISIBLE_DEVICES".upper(),
        ]
    ...
    def __init__(self, cuda_visible_devices=None) -> None:
        ...
        if cuda_visible_devices is not None:
            store[f"_{get_visible_devices_prefix()}_visible_devices".lower()] = cuda_visible_devices
    ...
    def get_cuda_visible_devices(self):
        ...
        visible_devices = os.environ.get(f"{get_visible_devices_prefix()}_VISIBLE_DEVICES".upper(), "not set")
