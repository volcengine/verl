...
class MegatronWorker(Worker):
    ...
    def _init_hf_config_and_tf_config(self, model_path, dtype, override_model_config, **transformer_config_kwargs):
        ...
        tf_config = hf_to_mcore_config(hf_config, dtype, **transformer_config_kwargs)
