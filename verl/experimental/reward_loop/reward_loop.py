...
class RewardLoopWorker:
    ...
    async def compute_score_disrm(self, data: DataProto) -> dict:
        ...
        if engine_name == "vllm":
            ...
            assert "choices" in output and output["choices"], (
                "TensorRT-LLM OpenAI server response for reward score is missing choices field"
            )
            ...
            print("***rm score: ", rm_score)  # TODO: to remove
        else:
