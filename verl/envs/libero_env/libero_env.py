...
class LiberoEnv(gym.Env):
    ...
    def chunk_step(self, chunk_actions):
        ...
        logger.error(f"libero env: chunk_rewards: {chunk_rewards}")
        logger.error(f"libero env: raw_chunk_terminations: {raw_chunk_terminations}")
        logger.error(f"libero env: raw_chunk_truncations: {raw_chunk_truncations}")
