...
class DataParallelPPOActor(BasePPOActor):
    ...
    def _forward_micro_batch(self, micro_batch, calculate_entropy=False) -> tuple[torch.Tensor, torch.Tensor]:
        """
        Returns:
    ...
    def update_policy(self, dataloader: Iterable[DataProto]):
        ...
        for mini_batch in dataloader:
            ...
            # only the first mini batch can be on policy
            if batch_idx == 0:
                on_policy = True
            else:
                on_policy = False
            ...
            for micro_batch in micro_batches:
                ...
                entropy, log_prob = self._forward_micro_batch(model_inputs, calculate_entropy=calculate_entropy)
