...
class RolloutWorker(Worker):
    ...
    def _get_token_ids_meta_info(self):
        ...
        if self.model_config.generation_config is not None:
            eos_token_id, pad_token_id = self.model_config.generation_config.eos_token_id, self.model_config.generation_config.pad_token_id
        if eos_token_id is None or pad_token_id is None:
            eos_token_id, pad_token_id = self.model_config.tokenizer.eos_token_id, self.model_config.tokenizer.pad_token_id
        if eos_token_id is None or pad_token_id is None:
