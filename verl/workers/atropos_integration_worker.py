...
from verl.workers.atropos_integration_client import SimpleAtroposClient, AtroposEnvironmentManager, TrajectoryBatch
...
class SimpleAtroposWorker(ActorRolloutRefWorker):
    ...
    def __init__(self, config: DictConfig, role: str = "actor_rollout_ref"):
        ...
        environment_config = atropos_config.get("environments", {
            "weights": {"gsm8k": 1.0},
    ...
    def generate_sequences(
        ...
        **kwargs
        ...
        try:
            ...
            trajectory_batch = self.env_manager.get_training_batch(
    ...
    def _convert_trajectory_to_dataproto(
        self, 
        ...
        non_tensor_batch = {
            "uid": trajectory_batch.groups,
            "environment_metadata": trajectory_batch.metadata
        }
