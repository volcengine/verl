...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        elif hasattr(actor_model_config, "thinker_config") and hasattr(actor_model_config.thinker_config, "vision_config"):
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        elif hasattr(critic_model_config, "thinker_config") and hasattr(critic_model_config.thinker_config, "vision_config"):
