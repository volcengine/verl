...
class ActorRolloutRefWorker(Worker):
    ...
    @register(dispatch_mode=Dispatch.ONE_TO_ALL)
    def save_checkpoint(self, local_path, hdfs_path=None, s3_path=None, global_step=0, max_ckpt_to_keep=None):        # only support save and load ckpt for actor
        assert self._is_actor
        import torch
...
class CriticWorker(Worker):
    ...
    @register(dispatch_mode=Dispatch.ONE_TO_ALL)
    def save_checkpoint(self, local_path, hdfs_path=None, s3_path=None, global_step=0, max_ckpt_to_keep=None):
        import torch
