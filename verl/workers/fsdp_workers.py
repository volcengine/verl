    ...
    def _build_rollout(self):
        ...
        if rollout_name == "hf":
            ...
            if rollout_name == "vllm":
                ...
                from verl.workers.sharding_manager import (
                    FSDPVLLMShardingManager as FSDPShardingManager,
                )
                ...
                from verl.workers.sharding_manager import (
                    FSDPSGLangShardingManager as FSDPShardingManager,
                )
            ...
            rollout_sharding_manager = FSDPShardingManager(
