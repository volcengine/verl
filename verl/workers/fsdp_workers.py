    ...
    def _build_model_optimizer(
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if use_liger:
                ...
                fused_linear_cross_entropy = not use_fused_kernels # use_liger and use_fused_kernels can not be both True
                _apply_liger_kernel_to_instance(model=actor_module, fused_linear_cross_entropy=fused_linear_cross_entropy)
