...
class MegatronSGLangShardingManager(BaseShardingManager):
    ...
    def __init__(self, module: AllGatherPPModel, inference_engine: VerlEngine, model_config, layer_name_mapping):
        from megatron.core import parallel_state as mpu
        self.module = module
        ...
        # need change
        self.tp_size = self.inference_engine._tp_size
        self.tp_rank = self.inference_engine._tp_rank
    ...
    def __enter__(self):
        ...
        log_gpu_memory_usage('Just enter MegatronSGLangShardingManager sharding manager memory', logger=None)
    ...
    def preprocess_data(self, data: DataProto) -> DataProto:
        ...
        # need change
        group = self.inference_engine._device_mesh.get_group()
