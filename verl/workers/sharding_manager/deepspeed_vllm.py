...
"""
DeepSpeed + vLLM Sharding Manager.

Handles data sharding and gathering for DeepSpeed training backend with vLLM inference.
Similar to FSDP vLLM sharding manager but optimized for DeepSpeed ZeRO.
"""
...
class DeepSpeedVLLMShardingManager(BaseShardingManager):
    ...
    def __init__(self, inference_engine, device_mesh: DeviceMesh, zero_stage: int = 2):
        ...
        logger.info(
            f"DeepSpeedVLLMShardingManager initialized: "
