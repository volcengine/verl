...
class CriticWorker(MegatronWorker):
    ...
    def _build_critic_model_optimizer(self, model_path, optim_config, override_model_config, override_transformer_config):
        ...
        self._init_hf_config_and_tf_config(model_path, self.dtype, override_model_config, override_transformer_config, tokenizer=self.config.model.tokenizer_path)
...
class RewardModelWorker(MegatronWorker):
    ...
    def _build_rm_model(self, model_path, override_model_config, override_transformer_config, rm_tokenizer=None):
        from megatron.core.models.gpt.gpt_model import ModelType

        from verl.utils.megatron_utils import get_model

        self._init_hf_config_and_tf_config(model_path, self.dtype, override_model_config, override_transformer_config, tokenizer=rm_tokenizer)
