...
from verl.trainer.actor.megatron_actor import MegatronPPOActor
from verl.trainer.critic.megatron_critic import MegatronPPOCritic
from verl.trainer.hybrid_engine import AllGatherPPModel
from verl.trainer.reward_model.megatron.reward_model import MegatronRewardModel
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_rollout(self):
        if self.config.rollout.name == 'vllm':
            ...
            from verl.trainer.hybrid_engine import MegatronVLLMShardingManager
