...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        rollout_correction (Optional[dict]): Rollout Correction configuration (nested dict).
            Set to None to disable entirely. When enabled, should contain:
            - rollout_is (str or None): IS weights aggregation level ("token", "sequence", or None)
            - rollout_is_threshold (float): Upper threshold for IS weights
            - rollout_rs (str or None): Rejection sampling mode ("token", "sequence", "geometric", or None)
    ...
    # Set to None to disable, or provide a dict with nested parameters
