...
def agg_loss(loss_mat: torch.Tensor, loss_mask: torch.Tensor, loss_agg_mode: str):
    ...
    if loss_agg_mode == "token-mean":
        ...
        # (loss_mask.shape[-1]) should ideally remain constant throughout
        # training to mimic the behaviour described in the DrGRPO paper.  The
        # divisor is therefore fixed to the sequence length.
    else:
