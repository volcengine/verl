...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        metrics_config=self.config.trainer.metrics

        data_src2var2metric2val = process_validation_metrics(data_sources, sample_inputs, reward_extra_infos_dict, metrics_config=metrics_config)
        metric_dict = {}
