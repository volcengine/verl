...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self):
        ...
        actor_s3_path = None if self.config.trainer.s3_checkpoint_dir is None else os.path.join(
            s3_global_step_folder, 'actor')
        ...
        if self.use_critic:
            ...
            critic_s3_path = None if self.config.trainer.s3_checkpoint_dir is None else os.path.join(
                s3_global_step_folder, 'critic')
