...
def compute_advantage(
    ...
    # prepare response group; additional estimators can be added in the future
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        # Other estimators can be supported by extending this branch
...
class RayPPOTrainer:
    """PPO trainer that orchestrates workers via Ray."""

    # Currently all roles share the same ``RayWorkerGroup`` implementation.  The
    # design allows for per-role customization in the future.
    def __init__(
        self,
        config: Any,
        tokenizer: Any,
    ...
    def _create_dataloader(self, train_dataset, val_dataset, collate_fn, train_sampler):
        ...
        """
        # Ensure that the per-device batch size divides evenly across the data
        # parallel group to avoid imbalanced workloads.
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # Decoding strips special tokens except for padding to produce human
            # readable prompts.
            input_texts = [
    ...
    def _load_checkpoint(self):
        ...
        if self.config.trainer.default_hdfs_dir is not None:
            ...
            # Use the local directory to locate checkpoints when resuming.
