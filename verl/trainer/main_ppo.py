...
class TaskRunner:
    ...
    def add_critic_worker(self, actor_rollout_cls, CriticWorker):
    ...
    def run(self, config):
        ...
        actor_rollout_cls, ray_worker_group_cls, CriticWorker = self.add_actor_rollout_worker(config)
        self.add_critic_worker(actor_rollout_cls, CriticWorker)
