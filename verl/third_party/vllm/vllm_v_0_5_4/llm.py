...
from verl.trainer.rollout.tokenizer import HybridEngineBaseTokenizer
        ...
        **kwargs,
        ...
        if not isinstance(tokenizer, tokenizer_cls):
            raise ValueError(
                ...
                "one of the following: PreTrainedTokenizer, PreTrainedTokenizerFast, verl.trainer.rollout.HybridEngineBaseTokenizer"
            )
