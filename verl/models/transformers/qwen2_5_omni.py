...
from verl.models.transformers.qwen2_vl import flash_attention_forward
from transformers.models.qwen2_5_omni import Qwen2_5OmniProcessor, Qwen2_5OmniForConditionalGeneration, Qwen2_5OmniThinkerTextModel
from transformers.models.qwen2_5_omni.modeling_qwen2_5_omni import Cache, Unpack, Union
from transformers.modeling_flash_attention_utils import _flash_attention_forward
from transformers.utils import is_flash_attn_greater_or_equal
from functools import wraps
from types import MethodType, FunctionType
from typing import Any, Dict, List, Literal, Optional, Tuple, TypeVar, Union, Mapping
...
from transformers.models.qwen2_5_omni.modeling_qwen2_5_omni import Qwen2_5OmniThinkerCausalLMOutputWithPast, Qwen2_5OmniThinkerForConditionalGeneration
...
def patch_model_mock_logits_spliting(model: Qwen2_5OmniForConditionalGeneration):
    # print("<DEBUG> patching model.thinker.forward to mock logits splitting")
    def split_after_forward(*args, **kwargs):
        ...
        # print(f'<DEBUG>before spliting: {world_size=}, {(outputs.logits.shape)=}')
        # if world_size>1:
        #     logits_rmpad = outputs.logits

        #     logits_rmpad, _, _ = ulysses_pad_and_slice_inputs(logits_rmpad.t(), position_ids_rmpad=None, sp_size=world_size)
        #     logits_rmpad_recovered = logits_rmpad.t()
        #     outputs.logits = logits_rmpad_recovered
        #     print(f'<DEBUG> after spliting: {(outputs.logits.shape)=}')
        return outputs
