...
This File deperacated if you have storage nodes connected to every calculation node, if you can only place data on rank 0 nodes, use function defined here.
