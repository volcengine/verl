...
def _get_block_submodules(
    ...
    # `BaseTransformerLayer` from the `transformer_layer.py` file.
        ...
        if issubclass(spec.module, TransformerBlockVision):
...
class TransformerBlockVision(MegatronModule):
    """Transformer class."""
    ...
    def get_cuda_graph_optional_args(
        ...
        try:
            ...
            if is_te_min_version("1.10.0", check_equality=False):
                assert not any([attention_mask, context, context_mask, rotary_pos_emb]), (
                ...
                for l_no, layer in enumerate(self.layers):
                    ...
                    with self.offload_context:
                        ...
                        if (len(self.cuda_graphs) == 0) or (not self.training):
                            ...
                            hidden_states = self.cuda_graphs[l_no][cg_index](hidden_states, **optional_inputs)
