...
class AtroposVeRLLauncher:
    ...
    async def start_atropos_server(self) -> bool:
        ...
        # Start API server
        cmd = [
            sys.executable, '-m', 'atroposlib.api',
            '--port', '8000',
            '--host', '0.0.0.0'
        ]
    ...
    async def start_atropos_environments(self) -> bool:
        ...
        for env_name in environments:
            ...
            env_scripts = {
                'gsm8k': 'environments/gsm8k_server.py',
                'humaneval': 'environments/humaneval_server.py',
                'tool_calling': 'environments/tool_calling_server.py'
            }
    ...
    async def register_inference_endpoints(self) -> bool:
        ...
        try:
            response = requests.post(
                f"{self.config['atropos']['api_url']}/register_inference_endpoints",
