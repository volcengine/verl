...
from .main_atropos import AtroposRLTrainer, AtroposAPIError
...
def main():
    ...
    parser.add_argument("--mode", choices=["demo", "training"], default="demo",
                       help="Mode to run: demo or training")
    parser.add_argument("--config", type=str, default="recipe/atropos/config/atropos_trainer.yaml",
                       help="Path to configuration file")
    parser.add_argument("--model_path", type=str, default="microsoft/DialoGPT-medium",
                       help="Model path for training")
    parser.add_argument("--atropos_url", type=str, default="http://localhost:9001",
    ...
    if os.path.exists(args.config):
        ...
        config = {
            ...
            "data": {
                "train_batch_size": args.batch_size * 8,
