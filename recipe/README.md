...
- [MoPPS](https://github.com/thu-rllab/MoPPS): A Bayesian framework for online predicting prompt difficulty and active prompt selection to accelerate RL finetuning of Large Reasoning Models ![GitHub Repo stars](https://img.shields.io/github/stars/thu-rllab/MoPPS)
