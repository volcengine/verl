    ...
    def _validate_config(self):
        ...
        if config.actor_rollout_ref.actor.strategy == "megatron":
            ...
            assert (
                ...
                times context_parallel_size ({config.actor_rollout_ref.actor.megatron.context_parallel_size})"
            )
            megatron_dp = n_gpus // (
        ...
        assert real_train_batch_size % minimal_bsz == 0, (
            ...
            minimal possible batch size ({minimal_bsz})"
        )
    ...
    def _create_dataloader(self, train_dataset, val_dataset, collate_fn, train_sampler):
        ...
        if self.stream_mode:
            assert self.config.trainer.total_training_steps is not None, (
                "total_training_steps must be set when stream_mode is True"
            )
