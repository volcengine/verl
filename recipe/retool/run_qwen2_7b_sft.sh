...
DATA_RELPATH="dataset/small_retool_preprocessed_dataset/train-00000-of-00001.parquet"
TRAIN_DATA=$DATA_ROOT/$DATA_RELPATH
EVAL_DATA=$DATA_ROOT/$DATA_RELPATH


MODEL_PATH=$DATA_ROOT/model/Qwen2.5-0.5B-Instruct
SAVE_PATH=$HOME/.cache/huggingface/own/models/rl/checkpoints/retool/$experiment_name
