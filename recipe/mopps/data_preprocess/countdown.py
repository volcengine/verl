...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="~/MoPPS/data/countdown3to4")
    ...
    try:
        ...
        if not os.path.exists(local_data_source):
            os.system(
                "pip install -U huggingface_hub; export HF_ENDPOINT=https://hf-mirror.com; huggingface-cli download --repo-type dataset --resume-download Jiayi-Pan/Countdown-Tasks-3to4 --local-dir data/countdown3to4/raw"
            )
        if os.path.exists(local_data_source):
            raw_dataset = load_dataset(
                "parquet", data_files={"train": os.path.join(local_data_source, "train-00000-of-00001.parquet")}
            )
