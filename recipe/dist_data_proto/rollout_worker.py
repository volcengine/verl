...
class RolloutWorker(Worker):
    def __init__(self, config: RolloutConfig, model_config: HFModelConfig) -> None:
        ...
        assert self.config.name == "vllm"  # TODO(caiyunke.astra): Generalize this implementation to support backends other than vllm.
        if self.config.name == "vllm":
            # from verl.workers.rollout.vllm_rollout import vLLMRollout
            from recipe.dist_data_proto.vllm_rollout_spmd import vLLMRollout
    ...
    def generate_sequences(self, prompts: DistDataProto):
