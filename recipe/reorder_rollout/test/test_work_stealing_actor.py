...
from recipe.reorder_rollout.chat_scheduler.utils import QueueGroup, WorkStealingActor
...
def test_work_stealing_behavior():
    ...
    async def async_test():
        ...
        actors = [
            WorkStealingActor(i, i, QueueGroup(num_workers, local_queues), global_queue, test_handler)
...
def test_queue_group_pop_from_longest():
    ...
    from recipe.reorder_rollout.chat_scheduler.utils import QueueGroup
