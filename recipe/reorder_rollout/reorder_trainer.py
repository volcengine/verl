...
class ReorderRolloutTrainer(RayPPOTrainer):
    ...
    def __init__(
        ...
        self.reorder_mode = config.actor_rollout_ref.rollout.reorder_mode
        super().__init__(
            config,
            tokenizer,
            role_worker_mapping,
    ...
    def _create_dataloader(self, train_dataset, val_dataset, collate_fn, train_sampler):
        ...
        reader_batch = 1 if self.reorder_mode else self.train_batch
        ...
        if self.reorder_mode:
            assert self.config.trainer.total_training_steps is not None, (
                "total_training_steps must be set when reorder_mode is True"
            )
