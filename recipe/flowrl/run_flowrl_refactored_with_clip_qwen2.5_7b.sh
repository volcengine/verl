...
# FlowRL Training Script (Refactored - IS Clipping)
project_name='FlowRL'
exp_name='FlowRL-clip-Qwen2.5-7B-refactored'
...
# FlowRL loss variant: clips importance weights to max=10.0
export FLOWRL_LOSS_VARIANT="flowrl_clip"

# TIS disabled for this variant
tis_imp_ratio_cap=0
clip_ratio_low=0.2
...
offload=False
gen_tp=1
python3 -m recipe.flowrl.main_flowrl_refactored \
