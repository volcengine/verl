{'actor_rollout_ref': {'actor': {'_target_': 'verl.workers.config.FSDPActorConfig',
                                 ...
                                 'profiler': {'_target_': 'verl.utils.profiler.ProfilerConfig',
                                              ...
                                              'tool': None,
                                              'tool_config': {
                                                  'npu': {'_target_': 'verl.utils.profiler.config.NPUToolConfig',
                                                          'analysis': True,
                                                          'contents': [],
                                                          'discrete': False,
                                                          'level': 'level1'},
 ...
 'trainer': {'balance_batch': True,
             ...
             'default_local_dir': './ckpts/DAPO/dapo_qwen2-7B-math_28k_fsdp2_fully-async_16-16_mbs32_tpf16_fixmcs',
             'del_local_ckpt_after_load': False,
             'device': 'cuda',
             'esi_redundant_time': 0,
             'experiment_name': 'dapo_qwen2-7B-math_28k_fsdp2_fully-async_16-16_mbs32_tpf16_fixmcs',
