...
- [ ] Apply [pre-commit checks](https://github.com/volcengine/verl?tab=readme-ov-file#code-linting-and-formatting). Use `pre-commit install && pre-commit run --all-files --show-diff-on-failure --color=always`.
